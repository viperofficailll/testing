      ...
      >
        ...
        >
          ...
          >
            ...
            <div id="frame420" className="bg-blue-500  absolute  left-[93px] min-w-[51px] w-auto min-h-[20px] h-auto justify-start gap-[6px] "></div>
            <div
              id="vector11"
              className=" w-0.5 h-[20px] bg-black absolute left-[164px] top-0   items-center"
            >
            </div>
            <div id="frame423" className="bg-red-600 position absolute left-[184px] top-[1px] min-w-[91px] w-auto min-h-[18px] justify-start gap-[6px]"></div>
          </div>
          <div
            id="text"
